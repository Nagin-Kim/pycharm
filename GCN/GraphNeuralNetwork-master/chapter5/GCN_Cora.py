...
class CoraData(object):
    ...
    def __init__(self, data_root="cora/data", rebuild=False):
    ...
    def process_data(self):
        ...
        _, tx, allx, y, ty, ally, graph, test_index = [self.read_data(
            osp.join(self.data_root, "FB13", name)) for name in self.filenames]
        train_index = np.arange(y.shape[0]) #y的数量
    ...
    def maybe_download(self):
        save_path = os.path.join(self.data_root, "FB13")
